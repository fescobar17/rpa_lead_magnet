...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  /* INTRO */
  #intro-screen .card{max-width:580px;width:100%;padding:3rem 2.5rem;text-align:center}
  ...
  .logo-mark::before{content:'';display:inline-block;width:6px;height:6px;background:var(--k-cyan);border-radius:50%}
  .logo-mark::after{content:'';display:inline-block;width:6px;height:6px;background:var(--k-cyan);border-radius:50%}
  ...
  .cta-top{display:block;text-align:center;padding:12px 28px;background:rgba(0,229,255,0.07);border:1px solid rgba(0,229,255,0.3);border-radius:50px;color:var(--k-cyan);font-weight:700;font-size:0.85rem;text-decoration:none;letter-spacing:1px;text-transform:uppercase;margin-bottom:1.5rem;cursor:pointer;transition:all 0.3s}
  .cta-top:hover{background:rgba(0,229,255,0.15);box-shadow:0 0 20px rgba(0,229,255,0.2)}
...
<div id="app">
  <h2 class="sr-only">Índice de Madurez de Automatización — Diagnóstico interactivo de KrugerTech</h2>
  ...
  <div class="screen" id="intro-screen">
    <div class="glass card" style="max-width:600px;width:100%;padding:3rem 2.5rem;text-align:center">
      ...
      <p style="margin-top:1.5rem;font-size:0.78rem;color:var(--k-muted)">Sin registro requerido · Resultados inmediatos</p>
    </div>
  </div>
  ...
  <div class="screen" id="results-screen">
    <div class="inner">
      <a href="https://fa6g8d848vm.typeform.com/to/fhpptYIr" target="_blank" class="cta-top">
      ...
      <a href="https://fa6g8d848vm.typeform.com/to/fhpptYIr" target="_blank" class="btn-cta-big">
...
<script>
const DIMS = [
  {name:"Dependencia manual",color:"#00e5ff",qs:[0,1]},
  {name:"Conocimiento crítico",color:"#4f8eff",qs:[2,3]},
  {name:"Complejidad y volumen",color:"#a78bfa",qs:[4,5,6]},
  {name:"Calidad y errores",color:"#ff9500",qs:[7,8,9]},
  {name:"Datos y gobernanza",color:"#ff5a00",qs:[10,11,12]}
];
...
function buildDimResults(){
  ...
  setTimeout(()=>{
    document.querySelectorAll('.dr-bar-fill').forEach(b=>{
